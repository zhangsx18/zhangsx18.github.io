...
/***/ function(module, exports, __webpack_require__) {
	...
	var ComponentBanner=__webpack_require__(170);
	var ComponentList=__webpack_require__(171);
	var ComponentFooter=__webpack_require__(172);
	/**声明这个页面的布局容器  开始**/
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ComponentHeader=React.createClass({displayName: "ComponentHeader",
		render:function(){
			...
			var _style=this.CSS;
			return(
				React.createElement("div", {style: _style._style}, 
				   React.createElement("img", {style: _style._img_stlye, src: _img})
				)
			);
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ComponentSearch=React.createClass({displayName: "ComponentSearch",
		render:function(){
			...
			return(
				React.createElement("div", null, 
				   React.createElement("section", {style: _style.search}, 
					React.createElement("div", {style: _style.searchbox}, 
					   React.createElement("img", {style: _style.searchimg, src: _img}), 
					   React.createElement("input", {style: _style.searchinput, type: "text", placeholder: "请输入搜索内容"})
					)
				)
				)
			);
	...
	var ComponentBanner=React.createClass({displayName: "ComponentBanner",
		...
		render:function(){
			...
			for(var i=0;i<_state.length;i++){
				...
				temp.push(React.createElement(ComponentBannerItem, {name: _state[i]}));
			}
			return(
				React.createElement("div", {style: _style.banner}, 
		...
		render:function(){
			...
			return(
				React.createElement("div", {className: "swiper-slide"}, 
				     React.createElement("img", {style: img, className: "swiper-img", src: _img})
			    )
			);
		},
		componentDidMount:function(){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ComponentList=React.createClass({displayName: "ComponentList",
		...
		render:function(){
			...
			for(var i=0;i<_state.length;i++){//遍历 1.每条数据传递给子组件  2.循环叠加子组件个数
				console.log(_state[i]);
				_temp.push(React.createElement(ComponentListItem, {name: _state[i]}));
			}
			return(
				React.createElement("div", {style: _css.cxt}, 
				    React.createElement("div", {style: _css.list}, 
						  _temp
					)
				)
			);
	...
	var ComponentListItem=React.createClass({displayName: "ComponentListItem",
		render:function(){
			...
			var _css=this.CSS;
			return(
				React.createElement("div", {style: _css.listitem}, 
							React.createElement("div", {style: _css.listimg}, 
								React.createElement("img", {style: _css.img, src: this.props.name.goodsListImg})
							), 
							React.createElement("div", {style: _css.itemdesc}, 
								React.createElement("div", {style: _css.goodsName}, name), 
								React.createElement("div", {style: _css.goodsPrice}, "￥", React.createElement("span", null, this.props.name.price)), 
								React.createElement("div", {style: _css.goodsDiscount}, this.props.name.discount), 
								React.createElement("div", {style: _css.goodsImg}, 
								    React.createElement("img", {style: _css.goodsimg, src: "img/shopcar.png"})
								)
							)
				)
			);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React=__webpack_require__(1);
	var ReactDOM=__webpack_require__(38);
	var NewComponent=__webpack_require__(173);
	var ComponentShopcar= __webpack_require__(174);
	...
	var ComponentFooter=React.createClass({displayName: "ComponentFooter",
		handleClick:function(event){
			...
			switch(_title){
				...
				case "classfy":
				  ...
				  ReactDOM.unmountComponentAtNode(document.getElementById("list"));
				  //装入新的组件
				  ReactDOM.render(React.createElement(NewComponent, null),document.getElementById("banner"));
				...
				case "shopcar":
				  ...
				  ReactDOM.unmountComponentAtNode(document.getElementById("list"));
				  //装入新的组件
				  ReactDOM.render(React.createElement(ComponentShopcar, null),document.getElementById("banner"));
		...
		render:function(){
			var _s=this.CSS;
			return(
				React.createElement("div", {style: _s.div}, 
				   React.createElement("div", {style: _s._div, onClick: this.handleClick, title: "index"}, "首页"), 
				   React.createElement("div", {style: _s._div, onClick: this.handleClick, title: "classfy"}, "分类"), 
				   React.createElement("div", {style: _s._div, onClick: this.handleClick, title: "shopcar", title: "shopcar"}, "购物车"), 
				   React.createElement("div", {style: _s._div, onClick: this.handleClick, title: "myshow", title: "myshow"}, "我的秀"), 
				   React.createElement("div", {style: _s._div, onClick: this.handleClick, title: "more", title: "more"}, "更多")
				)
			);
		}
	});
